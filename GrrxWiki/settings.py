"""
Django settings for GrrxWiki project.
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "wiki.context_processors.navbar_footer",
            ],
        },
    },
]
...
CKEDITOR_5_FILE_STORAGE = 'wiki.utils.CkeditorCustomStorage'
CKEDITOR_5_IMAGE_BACKEND = 'pillow'
CKEDITOR_5_JQUERY_URL = '//ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js'
